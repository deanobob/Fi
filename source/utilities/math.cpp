...
namespace utilities
{
    ...
    std::tuple<float, float> math::cartToIso(float cart_x, float cart_y)
    {
    ...
    utilities::vector2 math::cartToIso(const utilities::vector2& cart)
    {
    ...
    std::tuple<float, float> math::isoToCart(float iso_x, float iso_y)
    {
