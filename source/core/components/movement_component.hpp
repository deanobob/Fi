...
namespace core
{
        ...
        : public component
    {
            ...
            , m_velocity{velocity}
        {
            ...
            auto seg6 = std::make_unique<path_segment_curved>(seg5->get_end_position(), 50, 45, seg5->get_end_rotation(), true);
            auto seg7 = std::make_unique<path_segment_straight>(seg6->get_end_position(), seg6->get_end_rotation(), 170);
            auto seg8 = std::make_unique<path_segment_curved>(seg7->get_end_position(), 50, 45, seg7->get_end_rotation(), false);
